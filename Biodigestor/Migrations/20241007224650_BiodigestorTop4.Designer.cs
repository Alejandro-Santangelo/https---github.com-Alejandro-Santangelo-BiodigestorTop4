...
namespace Biodigestor.Migrations
{
    ...
    [Migration("20241007224650_BiodigestorTop4")]
    partial class BiodigestorTop4
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Biodigestor.Model.Personal", b =>
                {
            ...
            modelBuilder.Entity("Biodigestor.Models.Registro", b =>
                {
                    ...
                    b.Property<double?>("Alarma")
                        .HasColumnType("float");

                    b.Property<double?>("Alerta")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("Biodigestor.Models.SensorHumedad", b =>
                {
                    ...
                    b.ToTable("SensoresHumedad", (string)null);
                });
            ...
            modelBuilder.Entity("Biodigestor.Models.SensorPresion", b =>
                {
                    ...
                    b.ToTable("SensoresPresion", (string)null);
                });
            ...
            modelBuilder.Entity("Biodigestor.Models.UsuarioRegistradoModel", b =>
                {
                    b.Property<int>("IdUsuarioRegistrado")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("IdUsuarioRegistrado"));
            ...
            modelBuilder.Entity("Biodigestor.Models.SensorTemperatura", b =>
                {
                    b.HasOne("Biodigestor.Models.Biodigestor", "BiodigestorEntity")
                        .WithMany()
                        .HasForeignKey("IdBiodigestor")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("BiodigestorEntity");
                });
